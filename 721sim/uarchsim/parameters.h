...
extern bool SVP_VP;
extern int VPQ_SIZE;
extern int ORACLE_CONF;
extern int NUM_INDEX_BITS;
extern int NUM_TAG_BITS;
extern int MAX_CONF;

extern int vpmeas_ineligible;
extern int vpmeas_eligible;
extern int vpmeas_miss;
extern int vpmeas_conf_corr;
extern int vpmeas_conf_incorr;
extern int vpmeas_unconf_corr;
extern int vpmeas_unconf_incorr;
