...
bool SVP_VP = false;
int VPQ_SIZE = 0;
int ORACLE_CONF = 0; //by default oracle confidence
int NUM_INDEX_BITS = 0;
int NUM_TAG_BITS = 0;
int MAX_CONF = 3; // default conf = 3

/////////////////
int vpmeas_ineligible = 0;
int vpmeas_eligible = 0;
int vpmeas_miss = 0;
int vpmeas_conf_corr = 0;
int vpmeas_conf_incorr = 0;
int vpmeas_unconf_corr = 0;
int vpmeas_unconf_incorr = 0;
int INSTR_NUM=0;
...
uint32_t FU_LAT[(unsigned int) NUMBER_FU_TYPES] = {
   1 /* BR     */,
   3 /* LS     */,
   1 /* ALU_S  */,
   3 /* ALU_C  */,
...
ras_recover_e RAS_RECOVER_MODEL = ras_recover_e::RAS_RECOVER_TOS_POINTER_AND_CONTENT;
unsigned int COND_BRANCH_PRED_PER_CYCLE = 3;
unsigned int CBP_ALGORITHM = 0; /* 0: gshare, 1: tage-sc-l. */
